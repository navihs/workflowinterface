...
import Vues.ModeleTexte;;

public final class extendedattribute_jsp extends org.apache.jasper.runtime.HttpJspBase
...
{	/*Cas dans WorkflowPackage*/
	ea = wp.getExtendedAttributeByName(eaName);
      ...
      out.write('\r');
      out.write('\n');
      out.print(ModeleTexte.extendedAttribute(ea) );
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
